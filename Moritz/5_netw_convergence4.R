...
########### settings ###########
SETTINGS <- list(
  inputPath = "/Users/moritz/Documents/Research/TechnologicalChange/CoronaSci/RProgs/scientometrics/data/",
  outputPath = "/Users/moritz/Documents/Research/TechnologicalChange/CoronaSci/RProgs/scientometrics/src/",
...
########### load functions #########
source("/Users/moritz/Documents/Research/TechnologicalChange/CoronaSci/RProgs/scientometrics/src/aux_fcts.R")
source("/Users/moritz/Documents/Research/TechnologicalChange/CoronaSci/RProgs/scientometrics/src/netw_fcts.R")
...
world <- merge(world,countryClusters,by.x="adm0_a3", by.y="countryCode")

# filter out cluster 8 - a single country
idx <- world$cluster < 8 & !is.na(world$cluster)

colorset <- brewer.pal(8, "Set1")

crr_world <- ggplot(data = world[idx,]) +
  geom_sf(aes(fill = factor(cluster)), show.legend = TRUE) +
