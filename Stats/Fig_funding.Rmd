...
figa = ggplot(collapsed_df, aes(x = month)) + 
  geom_line(size=1,aes(y = n_paper_with_grant/n_papers, color='n_papers_with_grants',group=1)) + 
  geom_line(size=1,aes(y = n_paper_with_grant_corona/n_papers_corona, color='n_papers_with_grants_corona',group=1)) +
